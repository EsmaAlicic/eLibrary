...
export const addBook = (req,res) => {
    ...
    if(!token) return res.status(401).json("Not autentificirano!")
    ...
    jwt.verify(token,"unama", (err, userInfo)=>{
        ...
        db.query(q,[values],(err,data)=>{
            ...
            return res.json("Knjiga je kreirana");
        })
    })
}
...
export const deleteBook = (req,res) => {
    ...
    jwt.verify(token,"unama", (err, userInfo)=>{
        ...
        db.query(q,[bookId, userInfo.id], (err, data) =>{
            ...
            return res.json("Knjiga je obrisana!")
        })
    })
}
...
export const updateBook = (req,res) => {
    ...
    jwt.verify(token,"unama", (err, userInfo)=>{
        ...
        db.query(q,[...values,bookId,userInfo.id],(err,data)=>{
            ...
            return res.json("Knjiga je uređena");
        })
    })
}